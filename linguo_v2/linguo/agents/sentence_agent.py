...
TASK
----
Write an English sentence about "{topic}" that naturally uses the {language} word below.
...
RULES
-----
- The word "{foreign_word}" must appear literally in "sentence" — not its romanization or English meaning
                ...
                if result.foreign_word not in result.sentence:
                    if vocab_entry:
                        ...
                        result = GeneratedSentence(
                            sentence=f"She uses the word {result.foreign_word} often.",
